...
<body style="background-image: url(img/7de965ddeefc07fbdfb012a09caab478.jpg);background-repeat: no-repeat;background-size: 100vw 800px;">
    
   <section class="vh-100 gradient-custom">
                                <div class="container py-5 h-120">
                                        <div class="row justify-content-center align-items-center h-100">
                                            <div class="col-20 col-lg-10 col-xl-7">
                                                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;background-color: #00000085;">
                                                <div class="text-center mt-5">
                                                <img src="img/lg.png" style="width: 185px;" alt="logo">
                                            </div>
                                                    <div class="card-body p-4 p-md-5  ">
                                                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-light">Registration Form</h3>
                                                        <form class="row contact_form d-flex justify-content-center" action="controller/register.php" method="post" >
                                                                <div class="row " >
                                                                    <div class="col-md-6 mb-4">
                                                                    <div class="form-outline">
                                                                    <label class="form-label text-light" for="firstName"> Name</label>
                                                                        <input type="text" name="name" class="form-control form-control-lg" placeholder="Name" required />                           
                                                                    </div>
                                                                    </div>
                                                                    <div class="col-md-6 mb-4">
                                                                    <div class="form-outline">
                                                                    <label class="form-label text-light" for="lastName">Email</label>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="form-outline datepicker w-100">
                                                                        <label for="birthdayDate" class="form-label text-light">Password</label>
                                                                    ...
                                                                    <div class="col-md-6 mb-4">
                                                                        ...
                                                                        <div class="form-check form-check-inline">
                                                                            ...
                                                                            <label class="form-check-label text-light" for="otherGender">Other</label>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-md-6 mb-4 pb-2">
                                                                                ...
                                                                                <label class="form-label text-light" >Pin Code</label>
                                                                                    <input type="number" name="pincode" class="form-control form-control-lg"  placeholder="Pin Code" />                                                           
                                                                                </div>
                                                                                </div>
                                                                                <div class="col-md-6 mb-4 pb-2">

                                                                                <div class="form-outline">
                                                                                <label class="form-label text-light" for="phoneNumber">State</label>
                                                                                    <input type="tel" name="state" class="form-control form-control-lg"placeholder="State" required/>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                                <button type="submit" value="submit" name="sgn" class="btn btn-primary w-100 p-3 fw-bolder">
                                                                            Sign Up
                                                                    </button>
